...
def exemplo_simples():
    ...
    for detalhe in resultado["detalhes"]:
        ...
        emoji = (
            "✓" if status == "Sensibilizado com Sucesso" else "⚠️" if status == "Divergente" else "✗"
        )
...
def exemplo_analise_divergencias():
    ...
    divergentes = [d for d in resultado["detalhes"] if d["status_homologacao"] == "Divergente"]
    ...
    nao_sensibilizados = [
        d for d in resultado["detalhes"] if d["status_homologacao"] == "Não Sensibilizado"
    ]
